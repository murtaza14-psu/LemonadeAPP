package com.example.lemonsqueezeapp
...
import com.example.lemonsqueezeapp.ui.theme.LemonSqueezeAPPTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            LemonSqueezeAPPTheme {
...
fun LemonTextAndImage(
    ...
    Column (
        ...
        Button(
                onClick = imageClick,
                shape = RoundedCornerShape(dimensionResource(id = R.dimen.button_rounded)),
